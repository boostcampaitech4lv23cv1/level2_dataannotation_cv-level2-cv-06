...
DST_DATASET_DIR = '/opt/ml/input/data/ICDAR15_converted'  # FIXME
...
def main():
    ...
    mlt_train = MLT15Dataset(osp.join(SRC_DATASET_DIR, 'ch4_training_images'),
                             osp.join(SRC_DATASET_DIR, 'ch4_training_localization_transcription_gt'),
                             copy_images_to=dst_image_dir)
    # mlt_valid = MLT15Dataset(osp.join(SRC_DATASET_DIR, 'raw/ch8_validation_images'),
